...
/* Color picker (Figma "color picker"): label + hex pill on top, a 2D saturation/
   value area, a hue spectrum, and an eyedropper. HSV internally, hex out. */
  ...
  return (
    <div className="flex w-full flex-col gap-2">
      ...
      <div className="flex w-full items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            onClick={eyedrop}
            className="flex size-9 items-center justify-center rounded-xl border border-[#333] text-[#b3b3b3] transition-colors hover:bg-[#0d0d0d]"
          >
      ...
      <div
        ...
        onPointerMove={move}
        onPointerUp={up}
        className="relative h-[100px] w-full cursor-crosshair touch-none overflow-hidden rounded-2xl"
        style={{
